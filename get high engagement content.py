...
# Goal is to automatically select the best posts on instagram, given an instagram account. 

# The best posts on an instagram account are ones where engagement is highest. 
# We can gauge the relative sucess of a post by it's number of likes, relative to surrounding posts.

# Logic: 
# 1. Get likes of surrounding 20 posts. 
# Average the likes. 
# Get likes of the target post. 
# Compare target post like to average post likes. Code: Target post - average likes = Δ likes (how many likes the target post is different for its peers.)
# Record the Δ of the post, the URL, the number of comments, the position in the array of posts.  
# Do this for 100 posts. 
# Choose the top 5 posts based of biggest Δ. 
# Print out the top URLs. 


# Future: save the post files, Write a standard caption from a set of pre-determined captions, and post them automatically to our instagram account. = Profit.
